...
const HargaGroup = () => {
  return (
    <>
      <Helmet>
        <title>Paket Foto Group Termurah, Terbaik, Terbagus 2022</title>
        <meta
          name="description"
          content="Paket Foto Group dengan harga termurah di wilayah jogja dengan hasil yang terbaik."
        />
      </Helmet>
      <Container>
        <Shake>
          <Title>Paket Harga Foto Group</Title>
        </Shake>
            ...
            <ContainerHarga style={{borderTop: "10px solid gold" }} >
              <WrapperHarga>
                ...
                <ListContainer>
                  ...
                  <ListFasilitas>
                    <Icon src={IconCheckList} />
                    <List>Max 12 Orang</List>
                  </ListFasilitas>
                  <hr style={{ width: "100%" }} />
                  <ListFasilitas>
                    <Icon src={IconCheckList} />
                    <List>Unlimeted Shot</List>
                  </ListFasilitas>
                  <ListFasilitas>
                    <Icon src={IconCheckList} />
