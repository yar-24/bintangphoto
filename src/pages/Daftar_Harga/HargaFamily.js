...
const HargaFamily = () => {
  return (
    <>
      <Helmet>
        <title>Paket Foto Family Termurah 2022 ~ Bintang Photo</title>
        <meta
          name="description"
          content="Paket Foto Keluarga termurah di jogja dengan harga hemat di kantong untuk kenangan keluarga besar anda."
        />
      </Helmet>
      <Container>
        <Shake>
          <Title>Paket Harga Foto Family</Title>
        </Shake>
